...
// Reply 为跨服务统一的通用响应包装（业务数据外层的 code/message）。
type Reply struct {
...
// Metadata 用于 trace id 等调用链元数据透传。
...
const file_api_common_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x1aapi/common/v1/common.proto\x12\rapi.common.v1\"5\n" +
	"\x05Reply\x12\x12\n" +
	...
	"\bMetadata\x12\x19\n" +
	"\btrace_id\x18\x01 \x01(\tR\atraceIdB9Z7github.com/topcms/api-contracts/gen/go/api/common/v1;v1b\x06proto3"
